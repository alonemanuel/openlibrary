...
/**
 * Migrations are plain SQL, applied in order, tracked in `schema_migrations`.
 * Nothing here ever drops user data: the whole premise of this project is that
 * your library outlives the software that happens to be reading it today.
 */
...
export const MIGRATIONS: Migration[] = [
  {
    ...
    sql: `
      ...
      -- Append-only audit trail. Deletes are soft and every mutation is
      -- recorded, so a bug (or a bad actor) can never quietly lose history.
